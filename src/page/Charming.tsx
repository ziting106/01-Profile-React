    ...
    <>
      ...
      >
        <div>
          <h1>概念發想</h1>
          <p>
            一開始我們在選擇專題主題時，第一個考量的是組員們各自對於這個專題的期待，有人想做出令自己驕傲的網站，有人希望練習框架、擺在履歷上好看，有些人希望做出能夠後續發展、在市場上具有競爭力的網站。最後總結起來就是『不乏一點創新，但主要目的為精進大家coding技術的網站』。
          </p>
        </div>
        <div>
      ...
      >
        ...
        <div className={style.backgroundColorText}>
          <h1>市場調查</h1>
          <p>
            經過主題票選後，我們決定做「打工網」，於是開始參考市場現有的相關平台，例如大陸的「豬八戒網」、台灣的「104人力銀行」、1111人力銀行」、「meet.jobs」、「小雞打工」等，其中最打動我們的是以色列創作者接案平台「fiverr」。fiverr的經營模式讓我們不禁反思：為什麼在台灣，專業技能不能像在蝦皮買東西一樣，容易取得、種類多樣、還能貨比三家呢？
          </p>
        </div>
      </div>
      {/* 需求者環境評估 */}
      ...
      <div id="cssIssue" className={`${style.issue} ${style.cssIssue}`}>
        ...
        <div data-aos="fade" data-aos-duration="1000">
          <p>
            我們使用css-module解決了這個問題。css-module會將每一個className在輸出時轉為『JS檔案名稱_class__動態生成一段隨機碼』，如此在className的命名上就無須瞻前顧後的察看是否與伙伴衝突。另外我們也將會全域影響的CSS和通用樣式統一寫在app.module.css裡，節省了後續維護的時間。
          </p>
      ...
      <div id="dateLine" className={`${style.issue} ${style.cssIssue}`}>
        ...
        <div data-aos="fade" data-aos-duration="1000">
          <p>
            我們的解決辦法是「專業分工」。原本我們組員間的分工是功能取向，首頁、商品頁、會員中心、部落格系統等功能，各自負責該部分的前端和後端，但後來發現，大家有各自擅長和弱勢的技術，因此在繳交期限前兩個禮拜我與組員合作，各取所長，我接下他已經做好的後端來製作前端頁面，他則接下我的前端頁面串接後端，順利的完成了專題。
          </p>
          <a
